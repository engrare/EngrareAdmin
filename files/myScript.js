...
function submitOneWebPart() {
	...
	if(strlength == 19) {
		...
		if(link_temp.includes("https://drive.google.com/thumbnail?id=")) {
			...
			websiteJSON.website.slide.content[element_index].bgimglink = "https://drive.google.com/thumbnail?id=" + link_temp.slice(link_temp.indexOf("/d/") + 3, link_temp.lastIndexOf("/")) + "&sz=w1000";
		...
		if(link_temp.includes("https://drive.google.com/thumbnail?id=")) {
			...
			websiteJSON.website.corner[element_index].bgimglink = "https://drive.google.com/thumbnail?id=" + link_temp.slice(link_temp.indexOf("/d/") + 3, link_temp.lastIndexOf("/")) + "&sz=w1000";
